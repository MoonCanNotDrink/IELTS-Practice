...
本目录用于存放对外可读、面向项目协作与交付的双语文档，当前主要文档已同时提供中文与英文版本。
...
### `plans/`
存放功能实现计划、阶段计划、方案草案等文档。

### `reports/`
存放优化报告、总结报告、产品/设计摘要、阶段复盘等文档。
...
- [项目简介（中文）](项目简介.md)
- [Project Overview (English)](项目简介.en.md)
- [文档风格指南（中文）](style-guide.md)
- [Documentation Style Guide (English)](style-guide.en.md)
